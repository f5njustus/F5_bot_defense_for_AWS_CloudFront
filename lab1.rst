...
Task 6: Advanced Fields: Manual JS Insertion​
...
Task 10: AWS Console
  ...
  .. note:: Note: Your F5 XC Bot Defense configuration, such as protected endpoints, is sensitive security info and is stored in AWS Secrets Manager. You should delete config.json after CLI installation.
